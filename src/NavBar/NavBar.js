...
function NavBar() {
  const profileImg =
    "https://staticfe.saavn.com/web6/jioindw/dist/1696482270/_i/default_images/default-user-150x150.jpg";
      ...
      <div className="nav-container">
        <ul className="nav-left">
          <li
            ...
            onMouseLeave={() => setIsNavMusicHover(false)}
          >
          ...
          <li>
            <NavLink className="navlink podcasts" to="/original-podcasts">
              Podcasts
            </NavLink>
          </li>
          ...
          <li onClick={openWindowTabFunc}>
            <NavLink className="navlink">Go Pro</NavLink>
          </li>
        </ul>
